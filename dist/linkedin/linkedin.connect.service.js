...
class LinkedinConnectService extends linkedin_abstract_service_1.LinkedinAbstractService {
    ...
    async connectMethod3(page) {
        ...
        await this.moveMouseAndScroll(page, '.pv-top-card [aria-label="Connect"], .pv-top-card [data-control-name="connect"], .pv-top-card [type="connect"]', 2000);
        await page.evaluate(() => {
            var _a;
            return ((_a = document.querySelector('.pv-top-card [aria-label="Connect"], .pv-top-card [data-control-name="connect"], .pv-top-card [type="connect"]')) === null || _a === void 0 ? void 0 : _a.click());
        });
    }
